...
export default ({ app }) => {
  ...
  chimpPopup.appendChild(document.createTextNode('window.dojoRequire(["mojo/signup-forms/Loader"], function(L) { L.start({"baseUrl": "' +  MAILCHIMP_BASE_URL + '", "uuid": "' + MAILCHIMP_UUID + '", "lid": "' + MAILCHIMP_LID + '", "uniqueMethods":true})});'));
